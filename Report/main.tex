...
The partial gradient vector $g_i^{(t)} = [g_i^{(t)}(0), g_i^{(t)}(1), \ldots, g_i^{(t)}(l-1)]$ may require a large value of $l$ to be tolerant to stragglers or use a smaller $l$ but have less tolerance to stragglers. We shall drop the superscript $(t)$ for simplicity. 
...
\begin{theorem}
    ...
    \begin{enumerate}
        ...
        \item Each $f_i$ is a linear combination of the partial gradients $g_{i_1}, \ldots, g_{i_d}$
    \end{enumerate}
